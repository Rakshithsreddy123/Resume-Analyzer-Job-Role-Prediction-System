...
- Assist users in career planning
...
```bash
git clone https://github.com/Rakshithsreddy123/Resume-Analyzer.git
```
...
<p align="center">
    <img width="700" height="350" alt="image" src="https://github.com/user-attachments/assets/8798604d-36f4-459f-a0f5-9221d842f61a" />
...
<p align="center">
    <img width="700" height="350" alt="image" src="https://github.com/user-attachments/assets/0a9abb51-7071-4fe3-8c86-f7633e33f620" />
...
<p align="center">
    <img width="700" height="350" alt="image" src="https://github.com/user-attachments/assets/bce8766b-7a8d-4ad5-8015-3ab57d18037f" />
...
<p align="center">
    <img width="700" height="350" alt="image" src="https://github.com/user-attachments/assets/d8b5bb52-93df-4552-8f75-298d520305ab" />
...
- ☁️ Cloud deployment and authentication

---

## ✅ Conclusion

The **Resume Analyzer & Job Role Prediction System** leverages Machine Learning and NLP to automate resume evaluation, predict relevant job roles, and provide actionable feedback. It helps users optimize their resumes and make informed career decisions.
